                ...
                <?php foreach($ponentes as $ponente) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            ...
                            <form method="POST" onsubmit="return confirmDelete()" action="/admin/ponentes/eliminar" class="table__formulario">
                                <input type="hidden" name="id" value="<?php echo $ponente->id ;?>">
                                <button class="table__accion table__accion--eliminar type="submit">
                                    <i class="fa-solid fa-circle-xmark"></i>
                                    Eliminar
                                </button>
                            </form><script> function confirmDelete() { return confirm("¿Estás seguro de que deseas eliminar este ponente?"); } </script>
                        </td>
                    </tr>
                <?php } ?>    
            </tbody>
