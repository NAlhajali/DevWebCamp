<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="ciudad" class="fomulario__label">Ciudad</label>
        <input
            type="text"
            class="formuladio__input"
            id="ciudad"
    ...
    <div class="formulario__campo">
        <label for="pais" class="fomulario__label">País</label>
        <input
            type="text"
            class="formuladio__input"
            id="pais"
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Información Personal</legend>
    <div class="formulario__campo">
        <label for="tags_input" class="fomulario__label">Áreas de experiencias (separadas por una coma)</label>
        <input
            type="text"
            class="formuladio__input"   
            id="tags_input"
